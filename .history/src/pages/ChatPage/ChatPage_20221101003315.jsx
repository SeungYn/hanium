...
export default function ChatPage({ chatService }) {
  const so = new SockJS('https://2e9fb6909c9043.lhr.life/ws-test');
  console.log(so);
  const st = Stomp.over(so);
  // st.webSocketFactory = function () {
  //   return new SockJS('https://2e9fb6909c9043.lhr.life/ws-stomp');
  // };
  console.log(st);
  st.connect(
    {
      Authorization:
        'Bearer ' +
        'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxIiwiYXV0aCI6IlJPTEVfVVNFUiIsImV4cCI6MTY2NzIyOTc2M30.RpBLQ3y0NLGl5wfF7p2iGuXQ4pRCRldtvaBlpI_zYa3OxJOWbqZ6qCK5qaSFpLY7atECuPWskzAFMr4bKkmDFA',
    },
    (s) => {
  ...
  //   brokerURL: 'ws://2e9fb6909c9043.lhr.life',
