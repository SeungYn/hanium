...
export default function ChatPage({ chatService }) {
  ...
  const st = Stomp.over(
    () => new SockJS('https://2e9fb6909c9043.lhr.life:8080/ws-stomp')
  );
  st.connect(
    {
      Authorization:
        'Bearer ' +
        'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxIiwiYXV0aCI6IlJPTEVfVVNFUiIsImV4cCI6MTY2NzIyNzc3Mn0.Sr3UATjfTC0qZj6TQ6wHYGuU8qYtXAnMbvWUPaMR1rVYapPf8kqtPdEFOFMmaMfu477sePnS2bHE5Z6a2CqG9g',
    },
    (s) => {
